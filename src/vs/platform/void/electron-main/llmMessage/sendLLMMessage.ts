...
export const sendLLMMessage = ({
	...
	const onError: OnError = ({ message: error, fullError }) => {
		...
		if (error === 'TypeError: fetch failed')
			error = `Failed to fetch from ${displayInfoOfProviderName(providerName).title}. This likely means you specified the wrong endpoint in EH Code Settings, or your local model provider like Ollama is powered off.`
